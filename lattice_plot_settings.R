...
myColours_2_aq <-  c("#386CB0", "#FF7F00",  "#7FC97F", "#F0027F","#1B9E77","#F42E3C")  
...
#mylineTypes <- c("dotted","dashed","solid","dotdash","longdash","twodash", "dashed", "solid") #to use if we make v3
