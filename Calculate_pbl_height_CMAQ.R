#calculate pblh
#CMAQ heights are mid-level - which may explain the weirdness 
...
timeVariation(cmaq_pblh, pollutant = "pblh", type = "campaign", local.tz = "Etc/GMT-10")
